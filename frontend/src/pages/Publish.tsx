        ...
        <div className="flex justify-center w-full">
         ...
         <TextEditor onChange={(e)=>{
            setDescription(e.target.value)
                    ...
                    }} type="submit" className="mt-4 inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900
                    hover:bg-blue-800">
                    Publish post
                    </button>
        </div>
...
function TextEditor({onChange}:{onChange:(e: ChangeEvent<HTMLTextAreaElement>)=>void}) {
    return <div className="mt-2">
        ...
        <div className="w-full mb-4 " >
            <div className="flex items-center jutify-between px-3 border ">
