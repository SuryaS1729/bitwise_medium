    ...
    return <div className="bg-pink-800 h-screen flex justify-center flex-col ">
        ...
        <div className="flex justify-center px-4 ">
            <div className="max-w-lg"> 
                 ...
                 <div className="text-xl text-pink-300 font-semibold max-w-md mt-4"> Sahithi Natva</div>
                <div className="text-sm font-light max-w-md text-pink-200"> Student | IIM B</div>
             </div>
        </div>
